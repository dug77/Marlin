...
#define STRING_CONFIG_H_AUTHOR "(Douglas McKinnon " __DATE__ " " __TIME__ ")" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "3D Bob"

// Printer's unique ID, used by some programs to differentiate between machines.
// Choose your own or use a service like https://www.uuidgenerator.net/version4
#define MACHINE_UUID "1a63e6de-8879-468a-a54d-3025c5056a94"
...
/**
 * Thermal Overshoot
 * During heatup (and printing) the temperature can often "overshoot" the target by many degreesgg
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp 25.38
  #define DEFAULT_bedKi 4.74
  #define DEFAULT_bedKd 90.70
 ...
 *                                      X, Y, Z [, I [, J [, K]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_ACCELERATION      { 4000, 2000, 100, 10000 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 59, -18, -2.5 }
...
//#define RGBW_LED
  ...
  #define RGB_LED_G_PIN PF9
  #define RGB_LED_B_PIN PF8
